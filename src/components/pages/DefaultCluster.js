...
import { Flex, StyledDefaultWrapper, StyledBasicCluster, GiDiceSixFacesFour } from "../index";
        ...
        <StyledBasicCluster style={{ paddingTop: 0, margin: "auto" }}>
            <StyledDefaultWrapper>
                <Flex style={{ flexDirection: "column", gap: "0.5em" }}>
                    <Flex> <p style={{ color: "black" }}>default
                    </p>
                        <Link style={{ color: "#45C6E8", fontSize: "14px" }}>Edit</Link>
